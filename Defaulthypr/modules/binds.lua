...
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "U", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch exit"))

hl.bind(mainMod .. " + " .. "E", hl.dsp.exec_cmd("thunar"))

hl.bind(mainMod .. " + " .. "V", hl.dsp.window.float())

hl.bind(mainMod .. " + " .. "D", hl.dsp.exec_cmd("~/.config/rofi/launchers/type-1/launcher.sh || pkill rofi"))
...
hl.bind(mainMod .. " + " .. "U", hl.dsp.exec_cmd("hyprctl dispatch dpms on"))

hl.bind(mainMod .. " + " .. "I", hl.dsp.exec_cmd("hyprctl dispatch dpms off"))
...
-- hl.bind("$mainMod + SHIFT + l", hl.dsp.resizeactive("10 0"))

-- TODO: manual review (unknown dispatcher: resizeactive)
-- hl.bind("$mainMod + SHIFT + h", hl.dsp.resizeactive("-10 0"))

-- TODO: manual review (unknown dispatcher: resizeactive)
-- hl.bind("$mainMod + SHIFT + j", hl.dsp.resizeactive("0 10"))

-- TODO: manual review (unknown dispatcher: resizeactive)
-- hl.bind("$mainMod + SHIFT + k", hl.dsp.resizeactive("0 -10"))
